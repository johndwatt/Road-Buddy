...
const allConversationsShow = async function (req, res, next) {
    try {
...
//create message GET
const newMessageShow = async function (req, res, next) {
    try {
...
//create message POST
const newMessagePost = async function (req, res, next) {
    try {
...
const singleConversationShow = async function (req, res, next) {
    try {
